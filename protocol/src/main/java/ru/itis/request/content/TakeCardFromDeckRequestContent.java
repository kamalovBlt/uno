...
@Getter
public class TakeCardFromDeckRequestContent implements Content {
    ...
    public TakeCardFromDeckRequestContent(int gameId, int playerId) {
        this.gameId = gameId;
        this.playerId = playerId;
    }

    public TakeCardFromDeckRequestContent(byte[] data) {
